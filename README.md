...
See the [Moar Sugar Example App](https://github.com/farnsworth2008/moar-sugar-app/blob/master/src/main/java/moar/sugar/example/MoarSugarExampleApp.java) for additional examples.
